...
- QQ 音乐搜索、登录态与音源补充接入
- 本地曲库接入，支持文件夹扫描、ID3 解析、封面缓存与 LRC 歌词
...
本仓库在 [XxHuberrr/Mineradio](https://github.com/XxHuberrr/Mineradio) 基础上新增了本地曲库功能（文件夹扫描、ID3 解析、封面缓存、LRC 歌词）。所有原始功能与设计归属原作者 XxHuberrr。
